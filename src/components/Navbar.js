...
function Navbar() {
  ...
  <div class="container mx-auto flex flex-wrap items-center justify-between">
    ...
    <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
      ...
      {location.pathname === "/" ? (
                <li className="bg-pink-700 md:bg-transparent hover:text-gray-50 text-white block pl-3 pr-4 py-2 my-2 md:text-blue-700 md:p-0 rounded">
                  <Link to="/">Marketplace</Link>
                </li>
              ) : (
                <li className="bg-pink-700 hover:bg-gray-50 md:bg-transparent text-white block pl-3 my-2 pr-4 py-2 md:text-blue-700 md:p-0 rounded">
                  <Link to="/">Marketplace</Link>
                </li>
              )}
              {location.pathname === "/sellNFT" ? (
                <li className="text-white hover:bg-gray-50 border-b border-gray-100 my-2 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">
                  <Link to="/sellNFT">List My NFT</Link>
                </li>
              ) : (
                <li className="text-white hover:bg-gray-50 border-b border-gray-100 my-2 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">
